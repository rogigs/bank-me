...
import type {
  AssignorControllerFindManyParams,
  AssignorControllerFindOneParams,
  AssignorNoBaseModelDTO,
  EmailDTO,
  PayableControllerCreateManyBody,
  PayableControllerFindManyParams,
  PayableControllerFindOneParams,
  PayableControllerUploadFileBody,
  PayableNoBaseModelDTO,
  UserControllerFindManyParams,
...
export const getPayableControllerCreateUrl = () => {
  ...
  return `http://localhost:4000/api/v1/integrations/payable`
}
...
export const getPayableControllerCreateMutationKey = () => [`http://localhost:4000/api/v1/integrations/payable`] as const;
...
export const getPayableControllerFindManyUrl = (params: PayableControllerFindManyParams,) => {
  ...
  return normalizedParams.size ? `http://localhost:4000/api/v1/integrations/payable?${normalizedParams.toString()}` : `http://localhost:4000/api/v1/integrations/payable`
}
...
export const getPayableControllerFindManyKey = (params: PayableControllerFindManyParams,) => [`http://localhost:4000/api/v1/integrations/payable`, ...(params ? [params]: [])] as const;
...
export const getPayableControllerUpdateUrl = (id: string,) => {
  ...
  return `http://localhost:4000/api/v1/integrations/payable/${id}`
}
...
export const getPayableControllerUpdateMutationKey = (id: string,) => [`http://localhost:4000/api/v1/integrations/payable/${id}`] as const;
...
export const getPayableControllerFindOneUrl = (id: string,
  ...
  return normalizedParams.size ? `http://localhost:4000/api/v1/integrations/payable/${id}?${normalizedParams.toString()}` : `http://localhost:4000/api/v1/integrations/payable/${id}`
}
...
export const getPayableControllerFindOneKey = (id: string,
    params?: PayableControllerFindOneParams,) => [`http://localhost:4000/api/v1/integrations/payable/${id}`, ...(params ? [params]: [])] as const;
...
export const getPayableControllerRemoveMutationKey = (id: string,) => [`http://localhost:4000/api/v1/integrations/payable/${id}`] as const;
...
export const getPayableControllerCreateManyUrl = () => {
  ...
  return `http://localhost:4000/api/v1/integrations/payable/batch`
}
...
export const getPayableControllerCreateManyMutationKey = () => [`http://localhost:4000/api/v1/integrations/payable/batch`] as const;
...
export const getPayableControllerUploadFileUrl = () => {
  ...
  return `http://localhost:4000/api/v1/integrations/payable/upload`
}
...
export const getPayableControllerUploadFileMutationKey = () => [`http://localhost:4000/api/v1/integrations/payable/upload`] as const;
...
export const getAssignorControllerCreateUrl = () => {
  ...
  return `http://localhost:4000/api/v1/integrations/assignor`
}
...
export const getAssignorControllerCreateMutationKey = () => [`http://localhost:4000/api/v1/integrations/assignor`] as const;
...
export const getAssignorControllerFindManyUrl = (params: AssignorControllerFindManyParams,) => {
  ...
  return normalizedParams.size ? `http://localhost:4000/api/v1/integrations/assignor?${normalizedParams.toString()}` : `http://localhost:4000/api/v1/integrations/assignor`
}
...
export const getAssignorControllerFindManyKey = (params: AssignorControllerFindManyParams,) => [`http://localhost:4000/api/v1/integrations/assignor`, ...(params ? [params]: [])] as const;
...
export const getAssignorControllerUpdateUrl = (id: string,) => {
  ...
  return `http://localhost:4000/api/v1/integrations/assignor/${id}`
}
...
export const getAssignorControllerUpdateMutationKey = (id: string,) => [`http://localhost:4000/api/v1/integrations/assignor/${id}`] as const;
...
export const getAssignorControllerFindOneUrl = (id: string,
  ...
  return normalizedParams.size ? `http://localhost:4000/api/v1/integrations/assignor/${id}?${normalizedParams.toString()}` : `http://localhost:4000/api/v1/integrations/assignor/${id}`
}
...
export const getAssignorControllerFindOneKey = (id: string,
    params?: AssignorControllerFindOneParams,) => [`http://localhost:4000/api/v1/integrations/assignor/${id}`, ...(params ? [params]: [])] as const;
...
export const getAssignorControllerRemoveMutationKey = (id: string,) => [`http://localhost:4000/api/v1/integrations/assignor/${id}`] as const;
...
export const getUserControllerCreateUrl = () => {
  ...
  return `http://localhost:4000/api/v1/user`
}
...
export const getUserControllerCreateMutationKey = () => [`http://localhost:4000/api/v1/user`] as const;
...
export const getUserControllerFindManyUrl = (params: UserControllerFindManyParams,) => {
  ...
  return normalizedParams.size ? `http://localhost:4000/api/v1/user?${normalizedParams.toString()}` : `http://localhost:4000/api/v1/user`
}
...
export const getUserControllerFindManyKey = (params: UserControllerFindManyParams,) => [`http://localhost:4000/api/v1/user`, ...(params ? [params]: [])] as const;
...
export const getUserControllerUpdateUrl = (id: string,) => {
  ...
  return `http://localhost:4000/api/v1/user/${id}`
}
...
export const getUserControllerUpdateMutationKey = (id: string,) => [`http://localhost:4000/api/v1/user/${id}`] as const;
...
export const getUserControllerFindOneUrl = (id: string,
  ...
  return normalizedParams.size ? `http://localhost:4000/api/v1/user/${id}?${normalizedParams.toString()}` : `http://localhost:4000/api/v1/user/${id}`
}
...
export const getUserControllerFindOneKey = (id: string,
    params?: UserControllerFindOneParams,) => [`http://localhost:4000/api/v1/user/${id}`, ...(params ? [params]: [])] as const;
...
export const getUserControllerRemoveMutationKey = (id: string,) => [`http://localhost:4000/api/v1/user/${id}`] as const;
...
export const getEmailControllerSendMailerUrl = () => {
  ...
  return `http://localhost:4000/api/v1/email`
}
...
export const getEmailControllerSendMailerMutationKey = () => [`http://localhost:4000/api/v1/email`] as const;
...
export const getAuthControllerSignInUrl = () => {
  ...
  return `http://localhost:4000/api/v1/integrations/auth`
}
...
export const getAuthControllerSignInMutationKey = () => [`http://localhost:4000/api/v1/integrations/auth`] as const;
...
export const getAuthControllerGetProfileUrl = () => {
  ...
  return `http://localhost:4000/api/v1/integrations/auth/user`
}
...
export const getAuthControllerGetProfileKey = () => [`http://localhost:4000/api/v1/integrations/auth/user`] as const;
